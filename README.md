...
- **Players**: everyone on a current roster who averages 15+ minutes, on their current team. Stat leaders, scoring load vs. efficiency (highlight any teams or players), and a percentile profile with the player's headshot that you can compare against another player. Until new-season games are played, stats are from last season; after that they come from ESPN live. Rosters refresh automatically every Monday (a GitHub Actions workflow commits the latest from ESPN); **Refresh rosters** pulls them on demand, and *New in the rotation* lists rookies and breakout players once they reach 15 minutes a game.
